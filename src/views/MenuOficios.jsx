            ...
            <React.Fragment>
                  <Navbar/>
                    ...
                    <div className='row justify-content-center'> 
                            <Link className="link"  to="/carpinteria"><Buttons style={buttonStyle} title={'Carpintería'}/></Link>
                            ...
                            <Link className="link"  to="/electricidad"><Buttons style={buttonStyle} title={'Electricidad'}/></Link>
                    </div>
                </div>
            </React.Fragment>
        )
